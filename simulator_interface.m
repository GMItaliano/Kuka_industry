...
classdef simulator_interface < handle
    ...
    methods
        ...
        function [obj,error] = simulator_interface(remote_ip_address, remote_port)
            ...
            obj.TargetNames{1} = 'R1_L1';
            obj.TargetNames{2} = 'R1_L2';
            obj.TargetNames{3} = 'R1_L3';
            obj.TargetNames{4} = 'R1_L4';
            obj.TargetNames{5} = 'R1_L5';
            obj.TargetNames{6} = 'R1_L6';
            obj.TargetNames{7} = 'R1_L7';
            obj.TargetNames{8} = 'R1_L8';
            obj.TargetNames{9} = 'R2_L1';
            obj.TargetNames{10} = 'R2_L2';
            obj.TargetNames{11} = 'R2_L3';
            obj.TargetNames{12} = 'R2_L4';
            obj.TargetNames{13} = 'R2_L5';
            obj.TargetNames{14} = 'R2_L6';
            obj.TargetNames{15} = 'R2_L7';
            obj.TargetNames{16} = 'R2_L8';
            obj.TargetNames{17} = 'R3_L1';
            obj.TargetNames{18} = 'R3_L2';
            obj.TargetNames{19} = 'R3_L3';
            obj.TargetNames{20} = 'R3_L4';
            obj.TargetNames{21} = 'R3_L5';
            obj.TargetNames{22} = 'R3_L6';
            obj.TargetNames{23} = 'R3_L7';
            obj.TargetNames{24} = 'R3_L8';
            obj.TargetNames{25} = 'R4_L1';
            obj.TargetNames{26} = 'R4_L2';
            obj.TargetNames{27} = 'R4_L3';
            obj.TargetNames{28} = 'R4_L4';
            obj.TargetNames{29} = 'R4_L5';
            obj.TargetNames{30} = 'R4_L6';
            obj.TargetNames{31} = 'R4_L7';
            obj.TargetNames{32} = 'R4_L8';
            obj.TargetNames{33} = 'R5_L1';
            obj.TargetNames{34} = 'R5_L2';
            obj.TargetNames{35} = 'R5_L3';
            obj.TargetNames{36} = 'R5_L4';
            obj.TargetNames{37} = 'R5_L5';
            obj.TargetNames{38} = 'R5_L6';
            obj.TargetNames{39} = 'R5_L7';
            obj.TargetNames{40} = 'R5_L8';
            obj.TargetNames{41} = 'R6_L1';
            obj.TargetNames{42} = 'R6_L2';
            obj.TargetNames{43} = 'R6_L3';
            obj.TargetNames{44} = 'R6_L4';
            obj.TargetNames{45} = 'R6_L5';
            obj.TargetNames{46} = 'R6_L6';
            obj.TargetNames{47} = 'R6_L7';
            obj.TargetNames{48} = 'R6_L8';
