...
can_order = [
            LATA_COGUMELOS_1 , 2    ;       % {80} = 'R4_R8'
            LATA_COGUMELOS_2 , 2    ;       % {79} = 'R4_L7'
            LATA_SALSICHAS_1 , 1    ;       % {24} = 'R4_L8'
            LATA_COGUMELOS_3 , 2    ;
            LATA_SALSICHAS_2 , 1    ;
            LATA_SALSICHAS_3 , 1    
            ];
        ...
        case st_interm_place            % -> Place can on car
            ...
            switch stg
                ...
                case 2
                    ...
                    gain = 0.03;
                case 3
                    stg_2_pos = [storage_Position(1); storage_Position(2); storage_Position(3)+0.25];
    ...
    if (move_kuka && ( curr_st == st_transit || curr_st == st_idle )) && ~sig_reached
        ...
        switch move_kuka_stg
            ...
            case 2
                ...
                wrobot = target_orientation;
                if abs(target_orientation) < 0.01 || curr_st == st_idle
